...
public class PriceRangePickerDialogFragment extends DialogFragment implements RangeSliderListener {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final AlertDialog dial = new Builder(getActivity())
                .setPositiveButton("Ok", new OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(getContext(),"Price range of " + minPriceTxt.getText().toString()
                                + " - " + maxPriceTxt.getText().toString() + " selected.", Toast.LENGTH_LONG)
                                .show();
                    }
                })
        ...
        minPriceTxt = (TextView) slider.findViewById(R.id.min_price_txt);
        maxPriceTxt = (TextView) slider.findViewById(R.id.max_price_txt);
        priceSlider =(MaterialRangeSlider)slider.findViewById(R.id.price_slider);
